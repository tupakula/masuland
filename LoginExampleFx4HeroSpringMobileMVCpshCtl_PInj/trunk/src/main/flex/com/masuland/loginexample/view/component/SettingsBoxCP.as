...
//				ddl_layout.selectedItem = _currentLayout;
		...
		{
			EventBus.dispatchEvent(new LoadLayoutEvent(ddl_layout.selectedItem as LayoutVO));
		}
		
		protected function ddl_style_changeHandler(event:IndexChangeEvent):void
		{
			EventBus.dispatchEvent(new LoadStyleEvent(ddl_style.selectedItem as StyleVO));
		}
		
		protected function ddl_locale_changeHandler(event:IndexChangeEvent):void
		{
			EventBus.dispatchEvent(new LoadLocaleEvent(ddl_locale.selectedItem as LocaleVO));
		}
