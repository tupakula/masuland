package com.masuland.loginexample.view.component
{
	...
	public class UserBoxCP extends SkinnableComponent
	{
		...
		{
			ChangeWatcher.watch(appModel, 'currentUser', currentUser_changeHandler);
		}
		...
		protected function currentUser_changeHandler(event:Event):void
		{
			_currentUser = appModel.currentUser;
		...
		protected function btn_update_clickHandler(event:MouseEvent):void
		{
			...
			updateUserSignal.dispatch(_currentUser);
		}
