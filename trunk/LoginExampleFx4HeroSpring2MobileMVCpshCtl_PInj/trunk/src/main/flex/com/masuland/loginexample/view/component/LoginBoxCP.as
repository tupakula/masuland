package com.masuland.loginexample.view.component
{
	...
	public class LoginBoxCP extends SkinnableComponent
	{
		...
		public function doLoginOrRegister():void
		{
			...
			{
				StaticEventBus.dispatchEvent(new LoginEvent(auth));
			}
			else if (_loginBoxState == LoginBoxState.REGISTER)
			{
				StaticEventBus.dispatchEvent(new RegisterEvent(auth));
			}
		...
		{
			StaticEventBus.dispatchEvent(new AppEvent(AppEvent.GOTO_LOGIN));
		}
		
		public function gotoRegister():void
		{
			StaticEventBus.dispatchEvent(new AppEvent(AppEvent.GOTO_REGISTER));
		}
