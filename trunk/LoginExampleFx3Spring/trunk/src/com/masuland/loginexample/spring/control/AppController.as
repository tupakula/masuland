package com.masuland.loginexample.spring.control
{
	import com.masuland.loginexample.spring.business.IAppDelegate;
	...
	import com.masuland.loginexample.spring.state.AppStackState;
	...
	[Event(name="AppEvent.GET_SETTINGS",type="com.masuland.loginexample.spring.control.event.AppEvent")]
