package com.masuland.loginexample.action
{
	...
	public class AppController
	{
		...
		public function initApp(event:AppEvent):void
		{
			...
			// get settings
			EventBus.dispatchEvent(new AppEvent(AppEvent.GET_SETTINGS));
		}
...
*/		}
		...
		public function loadLayout(event:LoadLayoutEvent):void 
		{
			...
			{
				// load style
				EventBus.dispatchEvent(new LoadStyleEvent(StyleVO( appModel.currentLayout.styles.getItemAt(0) )));
				
				// load locales
				EventBus.dispatchEvent(new LoadLocaleEvent(LocaleVO( appModel.currentLayout.locales.getItemAt(0) )));
			}
		}
		...
		protected function getSettings_resultHandler(event:ResultEvent):void
		{
			...
			// load layout
			EventBus.dispatchEvent(new LoadLayoutEvent(LayoutVO( appModel.settings.layouts.getItemAt(0) )));
		}
